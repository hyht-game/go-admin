...
let _recipientInstance: ReturnType<typeof createInternalMessageRecipientServiceClient> | null =
  null;
...
export async function updateInternalMessage(
...
export async function deleteMessageCategory(
...
export async function deleteNotificationFromInbox(
