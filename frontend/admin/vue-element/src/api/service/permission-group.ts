...
let _instance: ReturnType<typeof createPermissionGroupServiceClient> | null = null;
...
export async function getPermissionGroup(request: permissionservicev1_GetPermissionGroupRequest) {
