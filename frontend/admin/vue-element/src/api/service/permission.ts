...
let _instance: ReturnType<typeof createPermissionServiceClient> | null = null;
...
export async function getPermission(request: permissionservicev1_GetPermissionRequest) {
  return getPermissionService().Get(request);
}

export async function createPermission(request: permissionservicev1_CreatePermissionRequest) {
  return getPermissionService().Create(request);
}

export async function updatePermission(request: permissionservicev1_UpdatePermissionRequest) {
  return getPermissionService().Update(request);
}

export async function deletePermission(request: permissionservicev1_DeletePermissionRequest) {
