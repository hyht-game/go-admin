export default {
  ...
  // 认证相关翻译
  'authentication.username': '用户名',
  'authentication.usernameTip': '请输入用户名',
  'authentication.password': '密码',
  'authentication.passwordTip': '请输入密码',
  'authentication.mobile': '手机号',
  'authentication.mobileTip': '请输入手机号',
  'authentication.mobileErrorTip': '手机号格式不正确',
